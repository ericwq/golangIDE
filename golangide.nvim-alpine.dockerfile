...
# Install COC extension: coc-go coc-json 
# remove coc-snippets: it requires python and a lot of python dependency.
WORKDIR  $HOME/.config/coc/extensions
RUN nvim --headless -c 'CocInstall -sync coc-go coc-json' -c qall &&\
